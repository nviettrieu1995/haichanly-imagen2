...
- Keep the cultural ground clearly Vietnam through Vietnamese faces and body language, warm family/classroom atmosphere, books, notebooks, tea/coffee, plants, and ordinary contemporary details. Split the pham-tran timeline by phase: before wisdom returns / before formal teaching, use poor present-day Vietnamese countryside/village settings with low houses, sparse lights, simple electric lighting, cement/tile floors, worn plaster/brick walls, simple furniture, and clean modern clothing; after Nalas starts teaching classes and disciples gather, the Earth setting can become cleaner, brighter, more modern, and more spacious because disciples support the class: proper tables/chairs, shelves, books, notebooks, whiteboard or magnetic board when natural, marker pens, modest tea or coffee service, organized students, and a khang trang Vietnamese teaching room in an ordinary city district. Do not put high-rise buildings, city skyline, apartment towers, busy traffic, or polished city interiors into the early countryside phase.
