...
def build_brief(chapter):
    ...
    if re.search(
        ...
        international_travel_note = (
            "- International travel/pilgrimage override: when a local excerpt names Cebu/Philippines, "
            "India, Nepal, Bihar, Gaya, Mahabodhi, Bodhi tree, Nalanda University, New Delhi, Patna, "
            "airport, plane, flight, bus, hotel, relic, ruins, or pilgrimage, follow that real-world "
            "place literally. Nalas remains the same Vietnamese pham-tran teacher with thin glasses "
            "and modern travel/teaching clothes, but the setting should not default back to Vietnam, "
            "a generic office-classroom, or old countryside imagery.\n"
        )
    modern_era_note = ""
    ...
    covid_style_note = ""
    if chapter >= MODERN_ERA_START_CHAPTER or re.search(
        r"\b(covid|pandemic|coronavirus|lockdown|quarantine|epidemic)\b",
        text_lower,
    ):
        covid_style_note = (
            "- Covid/pandemic-era teaching scenes should look polished and modern: "
            "LED ceiling panels or fluorescent tube lights, office-style desks and chairs, "
            "a proper magnetic whiteboard or whiteboard on wheels, visible marker pens and eraser, "
            "organized notebooks, bookshelves, tea/coffee, and a serious modern Vietnamese "
            "training-room/office-classroom feel. It can be more polished and better funded than "
            "earlier teaching rooms, but keep it warm and human, not corporate luxury, hotel styling, "
            "old wooden tea room, sci-fi lab, hospital drama unless explicitly medical, or ancient classroom.\n"
        )
